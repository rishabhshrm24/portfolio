...
const buttonVariants = cva(
  'inline-flex items-center justify-center whitespace-nowrap rounded-full text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        default: 'bg-primary text-primary-foreground shadow-[0_14px_40px_rgba(0,102,255,0.24)] hover:bg-primary/90',
        ...
        glow: 'border border-orange-200/80 bg-[linear-gradient(135deg,rgba(255,255,255,0.95),rgba(255,244,232,0.95))] text-foreground shadow-[0_0_0_1px_rgba(255,255,255,0.8),0_18px_55px_rgba(255,138,101,0.24)] hover:translate-y-[-1px]',
      },
      size: {
